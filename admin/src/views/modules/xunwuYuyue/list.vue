        ...
        <el-dialog title="审核" :visible.sync="xunwuYuyueYesnoTypesVisible">
            <el-form :model="form">
                ...
                <el-form-item label="审核" >
                    <el-select v-model="form.xunwuYuyueYesnoTypes" placeholder="请选择审核意见">
        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '认领编号' : ''">
                         <el-input prefix-icon="el-icon-search" v-model="searchForm.xunwuYuyueUuidNumber" placeholder="认领编号" clearable></el-input>
                     </el-form-item>
                                                 
                     <el-form-item :label="contents.inputTitle == 1 ? '审核意见' : ''">
                        <el-select v-model="searchForm.xunwuYuyueYesnoTypes" placeholder="请选择审核意见">
    ...
    //当前表下拉框搜索条件
            ...
            json_fields: {
                //级联表字段
                     ...
                     '学号/工号': 'yonghuEmail',
                //本表字段
                     '认领编号': "xunwuYuyueUuidNumber",
                     '特征描述': "xunwuYuyueText",
                     '照片': "xunwuYuyuePhoto",
                     '寻物启示报名时间': "insertTime",
                     '审核意见': "xunwuYuyueYesnoValue",
        ...
        methods: {
            ...
            xunwuYuyueUploadError(data){
                ...
                _this.form.xunwuYuyueYesnoTypes = "请选择审核意见";
                _this.xunwuYuyueYesnoTypesVisible = true;
            },

            xunwuYuyueYesnoTypesShenhe() {
                let _this = this;
                if(_this.form.xunwuYuyueYesnoTypes == "请选择审核意见"){
                    _this.$message.error("请选择审核意见");return false;
                }
