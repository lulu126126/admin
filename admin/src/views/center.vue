  ...
  <div>
    ...
    >  
     <el-row>
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='yonghu'"  label='学号/工号' prop="yonghuEmail">
               <el-input v-model="ruleForm.yonghuEmail"  placeholder='学号/工号' clearable></el-input>
           </el-form-item>
         </el-col>
    ...
    onUpdateHandler() {
                         ...
                         if((!this.ruleForm.yonghuPhoto)&& 'yonghu'==this.flag){
                             ...
                             if( 'yonghu' ==this.flag && this.ruleForm.yonghuEmail&&(!isEmail(this.ruleForm.yonghuEmail))){
                                 this.$message.error(`学号/工号应输入学号/工号格式`);
                                 return
                             }
