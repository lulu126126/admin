    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">攀枝花学院失物招领系统注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        -->
                        <el-form-item label="学号/工号" class="input" v-if="tableName=='yonghu'">
                            <el-input v-model="ruleForm.yonghuEmail" autocomplete="off" placeholder="学号/工号"  />
                        </el-form-item>
                        <!--
        ...
        methods: {
            ...
            login() {
                            ...
                            if('yonghu' == this.tableName && this.ruleForm.yonghuEmail&&(!this.$validate.isEmail(this.ruleForm.yonghuEmail))){
                                this.$message.error("学号/工号应输入邮件格式");
                                return
                            }
                            // yonghu 中的 创建时间 判空处理
